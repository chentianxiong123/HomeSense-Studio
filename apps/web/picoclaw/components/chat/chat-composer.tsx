...
import { ContextUsageRing } from "@pico/components/chat/context-usage-ring"
import { Button } from "@pico/components/ui/button"
import { cn } from "@pico/lib/utils"
import type { ChatAttachment, ContextUsage } from "@pico/store/chat"
      ...
      <div className="pointer-events-auto mx-auto flex max-w-[1000px] flex-col items-end">
        <div
          className={cn(
            ...
            isDragActive && "border-cyan-400/70 bg-cyan-500/5",
          )}
        ...
        >
          {isDragActive && (
            <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center rounded-2xl border-2 border-dashed border-cyan-400/70 bg-cyan-500/10">
