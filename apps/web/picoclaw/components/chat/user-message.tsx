...
import { useCopyToClipboard } from "@pico/hooks/use-copy-to-clipboard"
import { formatMessageTime } from "@pico/hooks/use-pico-chat"
          ...
          <div
            className={cn(
              ...
              isCommand
                ...
                : "rounded-2xl rounded-tr-sm bg-cyan-500 px-5 py-3 text-[15px] leading-relaxed text-white shadow-sm",
            )}
          >
            {isCommand ? (
