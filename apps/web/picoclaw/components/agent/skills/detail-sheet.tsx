...
import type { SkillDetailResponse, SkillSupportItem } from "@pico/api/skills"
import {
  MarkdownCodeBlock,
  MessageCodeBlock,
} from "@pico/components/chat/message-code-block"
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
const DETAIL_VIEWS: readonly SkillDetailView[] = [
  "preview",
  "raw",
  "meta",
]
