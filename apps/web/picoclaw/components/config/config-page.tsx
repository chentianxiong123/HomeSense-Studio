...
import { patchAppConfig, resetAppConfig } from "@pico/api/channels"
import { launcherFetch } from "@pico/api/http"
import { postLauncherDashboardSetup } from "@pico/api/launcher-auth"
import {
  getAutoStartStatus,
  getLauncherConfig,
...
import {
  ...
  MCPSection,
  RuntimeSection,
} from "@pico/components/config/config-sections"
import {
  type CoreConfigForm,
  EMPTY_FORM,
  EMPTY_LAUNCHER_FORM,
  ...
  parseMultilineList,
} from "@pico/components/config/form-model"
...
import { Badge } from "@pico/components/ui/badge"
