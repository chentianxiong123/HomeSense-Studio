...
import type { ChannelConfig } from "@pico/api/channels"
import {
  type ArrayFieldFlusher,
  ChannelArrayListField,
} from "@pico/components/channels/channel-array-list-field"
import {
  asStringArray,
  parseAllowFromInput,
  parseConservativeStringListInput,
} from "@pico/components/channels/channel-array-utils"
import { getSecretInputPlaceholder } from "@pico/components/channels/channel-config-fields"
import { Field, KeyInput, SwitchCardField } from "@pico/components/shared-form"
import { Card, CardContent } from "@pico/components/ui/card"
