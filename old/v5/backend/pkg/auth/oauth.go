...
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	// Client credentials come from the environment (ANTIGRAVITY_CLIENT_ID /
	// ANTIGRAVITY_CLIENT_SECRET) instead of being hardcoded, so the repo can be
	// published without leaking secrets.
