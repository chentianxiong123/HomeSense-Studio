...
describe('buildWorkflowStepSummary', () => {
  it('builds a device capability card summary with rehearsal and execution phases', () => {
  ...
  it('marks blocked rehearsal as warning and execution as blocked', () => {
    ...
    expect(summary?.phases).toEqual([
      { label: '沙箱演练|Rehearsal', value: '阻塞|Blocked', tone: 'warning' },
